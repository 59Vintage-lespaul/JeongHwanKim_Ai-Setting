...
## FPOF 컨텍스트
- 이 스킬은 커버낫의 시즌 기획(Plan 단계)에서 신규 카테고리/라인/IP 콜라보 아이디어를 발굴하는 데 활용합니다
...
- 커버낫의 어떤 전략적 목표에 연결되는가?
- 코어 타겟(20~27세 트렌드리더)의 어떤 니즈를 해결하는가?
- 기존 카테고리와의 차별점은?
...
- **프로덕트 디자이너 관점**: 사용자 경험, 온보딩, 인게이지먼트
  - 패션 컨텍스트: 디자인 컨셉, 프린트, 컬러, 시그니처 상품 활용
...
- 5대 경영목표와의 연결점
- 시그니처 상품(씨빅 등) · 앰버서더(추영우·TXT 수빈·최윤지) 활용 기회
