...
## FPOF 컨텍스트
- 이 스킬은 커버낫 브랜드의 신규 사업(IP 라이선싱, 글로벌 진출, 신규 카테고리 등) 전략 수립에 활용합니다
...
- *패션 맥락: Borderless Casual 감성, K-컬처 경험*
...
- *패션 맥락: K-컬처 + Borderless Casual 감성 + K-컬처 오리지널리티의 통합 방어력*
