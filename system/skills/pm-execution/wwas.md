...
- 커버낫 시즌 로드맵의 마일스톤을 백로그 아이템의 전략 맥락으로 활용
...
## 예시 (커버낫 컨텍스트)
```markdown
**제목:** 시그니처 상품 콜라보 상품 전용 랜딩 페이지

**Why:** 코어 타겟(20~27세)이 시그니처 상품 콜라보 상품에 높은 관심을 보이고 있으며,
전용 랜딩 페이지를 통해 캐릭터 세계관 몰입과 구매 전환율을 동시에 높일 수 있다.
이는 '히트상품 + IMC 강화' 경영목표에 직접 기여한다.

**What:** 씨빅 시그니처 콜라보 시즌 런칭에 맞춰 전용 랜딩 페이지를 제작한다.
