...
- **아웃컴 (전환)**:
  - Q2: 코어타겟이 커버낫만의 보더리스 캐주얼 아이덴티티를 경험하게 하여 브랜드 인지도 30% 향상
  - Q2: 시그니처 상품 팬덤이 패션에서도 자기표현 수단을 찾게 하여 IP 상품 매출 비중 15% 달성
  - Q2: 무신사 고객이 커버낫을 '발견의 기쁨'으로 경험하게 하여 채널 신규 유입 40% 증대
