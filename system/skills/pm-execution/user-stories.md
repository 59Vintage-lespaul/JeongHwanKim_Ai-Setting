...
- 커버낫 자사몰, 앱, 무신사 등 채널별 사용자 경험 차이를 스토리에 반영
- 고객(20~27세 트렌드리더)의 쇼핑 행동과 기대를 기반으로 스토리 작성
...
- 스토리가 커버낫 채널(자사몰, 무신사, 29CM 등)의 UX와 정합하는지 확인
...
**설명:** As a 커버낫 온라인 쇼퍼, I want to 좋아하는 라인(COVERNAT, AUTHENTIC, COLLEGE 등)으로 상품을 필터링하고 싶어서, so that 원하는 라인의 시즌 상품을 빠르게 찾을 수 있다.

**디자인:** [Figma 링크]

**수용 기준:**
1. 상품 리스트 페이지에 라인 필터가 노출됨
2. 필터 선택 시 해당 라인의 상품만 표시됨
3. 복수 라인 동시 선택 가능
